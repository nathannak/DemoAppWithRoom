...
import com.demo.demoapplication.room.StoreDao
import com.demo.demoapplication.room.StoreDatabase
...
class RepositoryDependencies @Inject constructor() {
    ...
    @Provides
    @Singleton
    fun provideAcronymDao(@ApplicationContext context: Context): StoreDao {
        return StoreDatabase(context).getStoreDao()
    }
